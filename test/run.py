...
# 三元素（iot后台获取）
ProductKey = 'k1v5jOtSrMb'
DeviceName = 'IOT_319'
DeviceSecret = "b2f48e2ed8538e37a880a4cac78cf424"
# topic (iot后台获取)
POST = '/sys/k1v5jOtSrMb/IOT_319/thing/event/property/post'  # 上报消息到云
POST_REPLY = '/sys/k1v5jOtSrMb/IOT_319/thing/event/property/post_reply'
SET = '/sys/k1v5jOtSrMb/IOT_319/thing/service/property/set'  # 订阅云端指令
